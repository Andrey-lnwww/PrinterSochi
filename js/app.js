    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".preview__slider")) new core(".preview__slider", {
                ...
                navigation: {
                    prevEl: ".preview__btn-slider-prev",
                    nextEl: ".preview__btn-slider-next"
                },
                on: {}
            });
            if (document.querySelector(".report-swiper__slider")) new core(".report-swiper__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                navigation: {
                    prevEl: ".report-swiper__btn-prev",
                    nextEl: ".report-swiper__btn-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: "auto",
                ...
                on: {
                    init: function(swiper) {
                        const allSlides = document.querySelector(".report-swiper__counter-all");
                        allSlides.innerHTML = swiper.slides.length - 2 < 10 ? `0${swiper.slides.length - 2}` : swiper.slides.length - 2;
                    },
                    slideChange: function(swiper) {
                        const currentSlide = document.querySelector(".report-swiper__counter-current");
        ...
        da.init();
        const social = document.querySelector(".preview__social");
        const moreSocial = social.querySelector(".preview-social__more");
        ...
        moreSocial.addEventListener("click", (e => {
            if (moreSocial.classList.contains("opened")) socialItems.forEach((item => {
                if (!item.classList.contains("preview-social__item--active")) {
                    ...
                    setTimeout((function() {
                        item.classList.add("preview-social__item--active");
                    }), 20);
                    moreSocial.classList.remove("opened");
                }
            })); else socialItems.forEach((item => {
                item.style.display = "none";
                item.classList.remove("preview-social__item--active");
                moreSocial.classList.add("opened");
            }));
        }));
        window["FLS"] = true;
        isWebp();
